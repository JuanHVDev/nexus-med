      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <Link href="/patient-portal/citas">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Link href="/patient-portal/recetas">
              <Button variant="outline" size="sm" className="mt-4 w-full">
                Ver recetas
              </Button>
            </Link>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Link href="/patient-portal/facturas">
              <Button variant="outline" size="sm" className="mt-4 w-full">
                Ver facturas
              </Button>
            </Link>
          ...
          <Card className="border-blue-200 bg-blue-50">
            <CardContent className="pt-4">
              <div className="flex items-center justify-between">
                ...
                <Link href="/patient-portal/resultados">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/patient-portal/historial">
            ...
            <Link href="/patient-portal/perfil">
              <Button variant="outline" className="w-full h-20 flex flex-col gap-1">
                <Calendar className="h-5 w-5" />
                <span className="text-xs">Mi Perfil</span>
              </Button>
            </Link>
            <Link href="/patient-portal/contacto">
              <Button variant="outline" className="w-full h-20 flex flex-col gap-1">
